...
export function TableCell({ children, className }: PropsWithChildren<GenericComponentProps>) {
    return <td className={classNames('px-6 py-4 space-y-2', className)}>{children}</td>
}
