...
async function createOneDriveWindow(instance: IPublicClientApplication) {
        ...
        case "command":
            ...
            switch (command.command) {
                ...
                default:
                    ...
                    console.log(`Unsupported command: ${JSON.stringify(command)}`);
                    break;
            }
